...
internal class OperationsDirectorTest {
    ...
    fun getRegisteredOperations() {
        assertEquals(
            opDirector.getRegisteredOperations(), "+\t- BINARY - LEFT - priority: 1\n" +
    ...
    fun getAssociativity() {
        ...
        val exceptionMessage =
            assertThrows(Exception::class.java, { opDirector.getAssociativity(OperationKey("^", Arity.BINARY)) })
